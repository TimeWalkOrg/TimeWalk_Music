...
ChronoTunes now supports Google Sheets integration for easy song database management! You can view and edit your song database directly in Google Sheets and sync changes back to your application.

### Quick Setup

1. Follow the detailed setup guide: [GOOGLE_SHEETS_SETUP.md](./GOOGLE_SHEETS_SETUP.md)
2. Once configured, use these commands:

```bash
# Upload your songs to Google Sheets
...
- 📊 **Spreadsheet View**: View all songs in an organized spreadsheet format
- ✏️ **Easy Editing**: Edit song data directly in Google Sheets
- 🔄 **Two-Way Sync**: Push local changes to sheets or pull sheet changes to local
- 🔒 **Secure**: Uses service account authentication
- 💾 **Backup**: Automatic backup before syncing from sheets
- 👥 **Collaboration**: Share the spreadsheet with team members

### Spreadsheet Columns

The Google Sheets integration includes all song metadata:
- ID, Title, Artist, Year
- Genre, Cultural Region
- Historical Significance
- Spotify URL, YouTube URL, Apple Music URL
